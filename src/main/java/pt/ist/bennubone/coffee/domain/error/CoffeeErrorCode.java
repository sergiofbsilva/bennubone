...
public enum CoffeeErrorCode {
    ...
    USER_NOT_FOUND(Response.Status.NOT_FOUND, 1000, "User not found"), ORDER_NOT_FOUND(Response.Status.NOT_FOUND, 1001,
	    "Order not found"), ORDER_BATCH_NOT_FOUND(Response.Status.NOT_FOUND, 1002, "Order batch not found");
